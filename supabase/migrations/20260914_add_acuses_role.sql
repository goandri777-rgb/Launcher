-- ALAS Launcher - rol exclusivo Acuses.
-- El usuario con role = 'acuses' solo puede descubrir y abrir Acuses de Recibo.

alter type public.user_role add value if not exists 'acuses';
